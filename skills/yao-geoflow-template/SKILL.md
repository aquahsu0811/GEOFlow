...
description: Use when mapping a reference URL to GEOFlow frontend modules and preparing a preview-first template package plan without changing business logic.
---
